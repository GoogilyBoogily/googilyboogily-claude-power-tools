...
`ai-sdk-expert`, `architect-reviewer`, `vite-expert`, `webpack-expert`, `cli-expert`, `linting-expert`, `code-review-expert`, `code-search`, `database-expert`, `mongodb-expert`, `optimizer`, `postgres-expert`, `devops-expert`, `documentation-expert`, `e2e-playwright-expert`, `flutter-expert`, `nextjs-expert`, `accessibility-expert`, `css-styling-expert`, `game-developer`, `git-expert`, `docker-expert`, `github-actions-expert`, `llm-architect`, `nestjs-expert`, `nodejs-expert`, `oracle`, `performance-engineer`, `product-manager`, `project-manager`, `prompt-engineer`, `react-expert`, `react-performance-expert`, `refactoring-expert`, `rust-engineer`, `technical-writer`, `testing-expert`, `triage-expert`, `build-expert`, `typescript-expert`, `type-expert`, `ux-researcher`
